...
<i class="fa fa-dashboard" ></i> Dashboard / Ndrysho Rreth Nesh
...
<i class="fa fa-money fa-fw"></i> Ndrysho Faqen Rreth Nesh
...
<label class="col-md-3 control-label"> Rreth Nesh Titulli: </label>
...
<label class="col-md-3 control-label"> Rreth Nesh Përshkrimi : </label>
...
<label class="col-md-3 control-label"> Reth Nesh Përshkrimi: </label>
