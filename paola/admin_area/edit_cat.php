...
<i class="fa fa-dashboard"></i> Dashboard / Ndrysho Kategori
...
<i class="fa fa-money fa-fw"></i> Ndrysho Kategori
...
<label class="col-md-3 control-label">Imazhi i Kategorisë</label>
