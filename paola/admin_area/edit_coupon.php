...
<i class="fa fa-money fa-fw"> </i> Ndrysho Kuponin
...
<label class="col-md-3 control-label"> Cmimi i kuponit </label>
...
<label class="col-md-3 control-label"> Kodi i Kuponit </label>
...
<label class="col-md-3 control-label"> Kohëzgjatja e kuponit </label>
...
<input type="submit" name="update" class=" btn btn-primary form-control" value=" Ndrysho Kuponin ">
