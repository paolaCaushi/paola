...
<i class="fa fa-dashboard"></i> Dashboard / Ndrysho Furnitorin
...
<i class="fa fa-money fa-fw"> </i> Ndrysho Furnitorin
...
<label class="col-md-3 control-label"> Zgjidh imazh </label>
...
<input type="submit" name="update" class="form-control btn btn-primary" value=" Ndrysho Furnitorin " >
