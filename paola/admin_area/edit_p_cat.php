...
<i class="fa fa-dashboard"></i> Dashboard / Ndrysho Kategorinë e Produkteve
...
<i class="fa fa-money fa-fw" ></i> Ndrysho Kategorinë e Produkteve
...
<label class="col-md-3 control-label" > Imazh</label>
...
echo "<script>alert('Kategoria e Produktit u ndryshua!')</script>";
