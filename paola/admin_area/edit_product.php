...
<i class="fa fa-dashboard"> </i> Dashboard / Ndrysho Produktet
...
<i class="fa fa-money fa-fw"></i> Ndrysho Produktet
...
<label class="col-md-3 control-label" > Zgjidh një furnitor </label>
...
<a data-toggle="tab" href="#description">Përshkrimi</a>
