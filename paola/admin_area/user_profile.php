...
<i class="fa fa-dashboard" ></i> Dashboard / Ndrysho Profilin
...
<i class="fa fa-money fa-fw" ></i> Ndrysho Profilin
...
<label class="col-md-3 control-label">Emri: </label>
...
<label class="col-md-3 control-label">Kontakti: </label>
...
<label class="col-md-3 control-label">Rreth Perdoruesit: </label>
