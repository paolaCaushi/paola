  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">BLI</span> KARTA
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<i class="fa fa-chevron-left"></i> Vazhdo blerjet
...
echo "<script>alert('Produkti nuk ekziston ne karte!')</script>";
...
echo "<script> alert('Kodi i kuponit nuk eshte i vlefshem!') </script>";
...
<h3 class="text-center"> Produkte qe mund t'ju pelqejne </h3>
...
<h3>Përmbledhja e porosive</h3>

</div><!-- box-header Ends -->

<p class="text-muted">
Transporti dhe kostot shtesë llogariten sipas vlerave që vendosni.
</p>
