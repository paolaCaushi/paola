...
<h1 align="center" > Redaktoni llogarinë tuaj </h1>
...
<label> Email-i i klientit: </label>
...
<label> Kontakt i klientit: </label>
...
<i class="fa fa-user-md" ></i> Përditëso Tani
...
echo "<script>alert('Llogaria juaj është përditësuar, ju lutemi identifikohuni përsëri')</script>";
