...
<a href="my_account.php?edit_account"> <i class="fa fa-pencil"></i> Edito Llogarinë </a>

</li>

<li class="<?php if(isset($_GET['change_pass'])){ echo "active"; } ?>">

<a href="my_account.php?change_pass"> <i class="fa fa-user"></i> Ndrysho Password </a>
...
<li class="<?php if(isset($_GET['my_piket'])){ echo "active"; } ?>">

<a href="my_account.php?my_piket"> <i class="fa fa-box"></i> Pikët e Mia </a>
