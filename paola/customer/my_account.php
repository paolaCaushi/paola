  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Llogaria </span>Ime
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<strong> Lajmerim! </strong> Ju lutemi konfirmoni emailin tuaj dhe nëse nuk e keni marrë emailin tuaj të konfirmimit
...
if(isset($_GET['my_piket'])){

  include("my_piket.php");
