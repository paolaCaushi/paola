  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Produkti </span>Shiko
      </div>
      <p class="nero__text">
      </p>
    </div>
...
echo "<script>alert('Produkti ndodhet ne karten tuaj!')</script>";
...
<label class="col-md-5 control-label" >Sasia e Produktit</label>

<div class="col-md-7" ><!-- col-md-7 Starts -->

<select name="product_qty" class="form-control" >

<option>Zgjidh sasinë</option>
<option>1</option>
<option>2</option>
<option>3</option>
<option>4</option>
...
<label class="col-md-5 control-label" >Madhësia e Produktit</label>

<div class="col-md-7" ><!-- col-md-7 Starts -->

<select name="product_size" class="form-control" >

<option>Zgjidh madhesine</option>
<option>S</option>
<option>M</option>
<option>L</option>
