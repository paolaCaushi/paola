...
if(!isset($_SESSION['customer_email'])){
  ...
  { 
      echo '<a href="customer/my_account.php?my_orders" class="login__link">Llogaria Ime</a>';
  }   
?>  
</li>
    ...
    <div class="page-header__bottomline">
      <div class="container clearfix">
        ...
        <div class="logo">
          ...
          <img class="logo__img" src="images/logo1.png" alt="Special Card" width="150" height="10">          </a>
        </div>
